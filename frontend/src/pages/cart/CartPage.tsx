...
  const navigate = useNavigate() // ⬅️ Khởi tạo Hook useNavigate
  const shipping = 200000

  // ⬅️ Hàm chuyển hướng đến trang thanh toán
  const handleCheckout = () => {
    // Kiểm tra nếu giỏ hàng trống thì không cho checkout
    if (cartItems.length === 0) {
      alert("Giỏ hàng của bạn đang trống!");
      return;
    }
    navigate('/checkout'); // ⬅️ CHUYỂN HƯỚNG ĐẾN TRANG /checkout
  };
...
            <div className="p-6 bg-[#0f0f10] border border-gray-800 rounded-xl sticky top-28">
...
              {/* ⬅️ GẮN SỰ KIỆN handleCheckout CHO BUTTON */}
              <Button onClick={handleCheckout} className="w-full bg-blue-600 hover:bg-blue-700 mb-3">Tiến hành thanh toán</Button>
              <Button className="w-full bg-transparent border border-gray-800 text-gray-300 hover:bg-gray-800">Tiếp tục mua sắm</Button>
